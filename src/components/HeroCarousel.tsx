...
const HeroCarousel = () => {
  ...
  return (
<div className="relative h-[480px] md:h-[500px] overflow-hidden rounded-2xl shadow-medium">
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center bg-black/30">
            <div className="text-center text-white px-4 max-w-3xl">
              ...
              <Link
                to={slide.buttonLink}
                className="btn-hero inline-block animate-scale-in"
              >
                {slide.buttonText}
              </Link>
            </div>
      ...
      <button
        onClick={prevSlide}
        className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-3 rounded-full transition-smooth"
      ...
      <button
        onClick={nextSlide}
        className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 text-white p-3 rounded-full transition-smooth"
